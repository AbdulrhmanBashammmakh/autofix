 ...
 * @author shammakh
 */
public class PurchController1 implements Initializable {
...
//   DBconnection coo =new DBconnection();
    //    Class<? extends DBconnection> aClass = coo.getClass().;
  ...
  */
    ...
    init2();
        try {
            ...
            Logger.getLogger(PurchController1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @FXML
    private void ShowMePur(ActionEvent event) {
