...
public DetailsPurchase(int DP ,int Code ,String Title ,int ID_Unit ,int Qty,double PriceP,double Total,int GnP){
 ...
 public IntegerProperty Unit_Property(){
        return ID_Unit;
    }
...
public int getDP() {
    ...
    public DetailsPurchase(IntegerProperty DP, IntegerProperty Code, StringProperty Title, IntegerProperty ID_Unit, IntegerProperty Qty, DoubleProperty PriceP, DoubleProperty Total, IntegerProperty GnP) {
        this.DP = DP;
        this.Code = Code;
        this.Title = Title;
